...
function ratings_css() {
	...
	echo '/* Start Of CSS Generated By WP-PostRatings 1.02 */'."\n";
	echo "\t".'.post-ratings {'."\n";
	echo "\t\t".'width:100%;'."\n";
	...
	echo "\t\t".'opacity: 1;'."\n";
	echo "\t".'}'."\n";
	echo '/* End Of CSS Generated By WP-PostRatings 1.02 */'."\n";
	echo '</style>'."\n";
}
...
function the_ratings_vote_js() {
	...
	echo '/* Start Of Javascript Generated By WP-PostRatings 1.02 */'."\n";
	echo '/* <![CDATA[*/'."\n";
	echo "\t".'var ratings = new sack(\'index.php\');'."\n";
	echo "\t".'var post_id = 0;'."\n";
	echo "\t".'var post_rating = 0;'."\n";
	echo "\t".'var rate_fadein_opacity = 0;'."\n";
	echo "\t".'var rate_fadeout_opacity = 100;'."\n";
	echo "\t".'var is_ie = (document.all && document.getElementById);'."\n";
	echo "\t".'var is_moz = (!document.all && document.getElementById);'."\n";
	echo"\t".'function rade_fadein_text() {'."\n";
	echo "\t\t".'if(rate_fadein_opacity < 100) {'."\n";
	echo "\t\t\t".'rate_fadein_opacity += 10;'."\n";
	echo "\t\t\t".'if(is_ie) document.getElementById(\'post-ratings-\' + post_id).filters.alpha.opacity = rate_fadein_opacity;'."\n";
	echo "\t\t\t".'if(is_moz) document.getElementById(\'post-ratings-\' + post_id).style.MozOpacity = (rate_fadein_opacity/100);'."\n";
	echo "\t\t\t".'setTimeout("rade_fadein_text()", 100); '."\n";
	echo "\t\t".'} else {'."\n";
	echo "\t\t\t".'rate_fadein_opacity = 100;'."\n";
	echo "\t\t".'}'."\n";
	echo"\t".'}'."\n";
	...
	echo "\t\t".'if(rate_fadeout_opacity > 0) {'."\n";
	echo "\t\t\t".'rate_fadeout_opacity -= 10;'."\n";
	echo "\t\t\t".'if(is_ie) document.getElementById(\'post-ratings-\' + post_id).filters.alpha.opacity = rate_fadeout_opacity;'."\n";
	echo "\t\t\t".'if(is_moz) document.getElementById(\'post-ratings-\' + post_id).style.MozOpacity = (rate_fadeout_opacity/100);'."\n";
	echo "\t\t\t".'setTimeout("rate_post()", 100); '."\n";
	echo "\t\t".'} else {'."\n";
	echo "\t\t\t".'rate_fadeout_opacity = 0;'."\n";
	...
	echo "\t\t\t".'ratings.onCompletion = rade_fadein_text;'."\n";
	echo "\t\t\t".'ratings.runAJAX();'."\n";
	echo "\t\t\t".'rate_fadein_opacity = 0;'."\n";
	echo "\t\t\t".'rate_fadeout_opacity = 100;'."\n";	
	echo "\t\t".'}'."\n";
	echo "\t".'}'."\n";
	echo '/* ]]> */'."\n";
	echo '/* End Of Javascript Generated By WP-PostRatings 1.02 */'."\n";
	echo '</script>'."\n";
}
