...
### Function: Ratings Stylesheet
add_action('wp_print_styles', 'ratings_stylesheets');
function ratings_stylesheets() {
...
### Function: Enqueue Ratings JavaScripts
add_action('wp_footer', 'ratings_javascripts');
function ratings_javascripts() {
	...
	wp_register_script('wp-postratings', plugins_url('wp-postratings/postratings-js.js'), array('jquery'), '1.50');
	...
	wp_print_scripts('wp-postratings');
}
...
### Function: Print Ratings JavaScripts In WP-Admin
add_action('admin_footer-wp-postratings/postratings-manager.php', 'ratings_javascripts_admin');
add_action('admin_footer-wp-postratings/postratings-options.php', 'ratings_javascripts_admin');
add_action('admin_footer-wp-postratings/postratings-templates.php', 'ratings_javascripts_admin');
add_action('admin_footer-wp-postratings/postratings-uninstall.php', 'ratings_javascripts_admin');
function ratings_javascripts_admin() {
	wp_register_script('wp-postratings-admin', plugins_url('wp-postratings/postratings-admin-js.js'), array('jquery'), '1.50');
	echo '<!-- Start Of Script Generated By WP-PostRatings 1.50 -->'."\n";
	...
	wp_print_scripts('wp-postratings-admin');
	echo '<!-- End Of Script Generated By WP-PostRatings 1.50 -->'."\n";
}
