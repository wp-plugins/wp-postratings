...
function the_ratings_header() {
	...
	wp_register_script('wp-postratings', '/wp-content/plugins/wp-postratings/postratings-js.php', false, '1.30');
	wp_print_scripts(array('sack', 'wp-postratings'));
	if(@file_exists(get_template_directory().'/postratings-css.css')) {
	...
	echo '<!-- End Of Script Generated By WP-PostRatings 1.30 -->'."\n";
}
...
function ratings_header_admin() {
	wp_register_script('wp-postratings-admin', '/wp-content/plugins/wp-postratings/postratings-admin-js.php', false, '1.30');
